...
*/
	...
	// now bind the columns and fetch
	mysqli_stmt_bind_result($stmt, $dbUsername, $dbHash);
	mysqli_stmt_fetch($stmt);

	// Check if the confirmation password matches the password in the database
	if (!password_verify($passwordFiltered, $dbHash)){
	...
	// Delete the user
	$deleteSql = "DELETE FROM players WHERE username = ?";
